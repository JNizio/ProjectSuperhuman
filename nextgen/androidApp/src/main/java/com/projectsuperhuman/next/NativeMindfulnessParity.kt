    ...
    Column(
        ...
        Column(Modifier.fillMaxWidth().background(MindPurple.copy(alpha = .08f), RoundedCornerShape(22.dp)).padding(16.dp)) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(10.dp), modifier = Modifier.fillMaxWidth()) {
                OutlinedTextField(
                    value = stressBefore,
                    onValueChange = { stressBefore = it.filter { c -> c.isDigit() || c == '.' }.take(4) },
                ...
                OutlinedTextField(
                    value = stressAfter,
                    onValueChange = { stressAfter = it.filter { c -> c.isDigit() || c == '.' }.take(4) },
                    modifier = Modifier.weight(1f),
                    singleLine = true,
                    label = { Text("After") }
                )
            ...
            Spacer(Modifier.height(10.dp))
            Box(
                Modifier.fillMaxWidth().background(MindGreen, RoundedCornerShape(16.dp)).clickable { saveSession() }.padding(14.dp),
                contentAlignment = Alignment.Center
